...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>unfiled$public/Recruiting_App</template>
    </alerts>
    <fieldUpdates>
...
process, its status should be set to Pending Approval.</description>
    ...
    <rules>
        ...
        <description>Reassign Positions to Recruiters if they are submitted by another type of employee.</description>
        <triggerType>onCreateOnly</triggerType>
        <workflowTimeTriggers>
            <actions>
                <name>Unclaimed_Position_record_to_Recruiter</name>
                <type>Task</type>
            </actions>
    ...
    <tasks>
        <fullName>Unclaimed_Position_record_to_Recruiter</fullName>
        ...
        <subject>Unclaimed Position record to Recruiter</subject>
    </tasks>
</Workflow>
